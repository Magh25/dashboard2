...
<section class="wrapper angled lower-start">
    ...
    <div class="row gx-lg-8 gx-xl-12 gy-12 align-items-center">
      <div class="col-lg-6 position-relative">
        ...
        <div class="row gx-md-5 gy-5 align-items-center">
          <div class="col-md-6">
            <div class="row gx-md-5 gy-5">
              <div class="col-md-10 offset-md-2">
                <figure class="rounded"><img src="/assets/img/photos/7.jpg" srcset="./assets/img/photos/ab1@2x.jpg 2x" alt=""></figure>
              </div>
              <!--/column -->
              <div class="col-md-12">
                <figure class="rounded"><img src="/assets/img/photos/7.jpg" srcset="./assets/img/photos/ab2@2x.jpg 2x" alt=""></figure>
              </div>
              <!--/column -->
            </div>
            <!--/.row -->
          ...
          <!--/column -->
          <div class="col-md-6">
            <figure class="rounded"><img src="/assets/img/photos/6.jpg" srcset="./assets/img/photos/ab3@2x.jpg 2x" alt=""></figure>
          </div>
          <!--/column -->
        </div>
        <!--/.row -->
      ...
      <!--/column -->
      <div class="col-lg-6">
        <img src="/assets/img/photos/6.jpg" class="svg-inject icon-svg icon-svg-md mb-4" alt="" />
